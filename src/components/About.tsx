export function About() {
  return (
    <section id="sobre" data-section className="px-[5%] py-24 text-center lg:px-[8%]">
      <div data-section-header className="mx-auto max-w-3xl">
        <div className="mb-4 font-serif text-base font-semibold uppercase tracking-[0.16em] text-[#e6578f]">
          Sobre Mim
        </div>
        <h2 className="mb-5 font-serif text-[clamp(28px,3vw,40px)] font-semibold leading-tight text-[#1a1018]">
